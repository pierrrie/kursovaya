...
urlpatterns = [
    ...
    path("dentist-documents/research/", views.dentist_research_view, name="dentist_research"),
    path("dentist-documents/research/create/", views.dentist_research_create_view, name="dentist_research_create"),
    path("dentist-documents/prescriptions/", views.dentist_prescriptions_view, name="dentist_prescriptions"),
    path("dentist-documents/prescriptions/create/", views.dentist_prescription_create_view, name="dentist_prescription_create"),
    path("dentist-documents/teeth/", views.dentist_teeth_view, name="dentist_teeth"),
    path("dentist-documents/teeth/create/", views.dentist_tooth_create_view, name="dentist_tooth_create"),
